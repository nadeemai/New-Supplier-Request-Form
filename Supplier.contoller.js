...
<head>
    ...
    <style>
        ...
        .section-header { background-color: #800080; color: #fff; padding: 10px; margin-bottom: 15px; border-radius: 4px; }
        ...
        .input-with-button button:disabled { background-color: #d3d3d9; cursor: not-allowed; }
...
<body>
    <div class="detailed-form-container">
        <div class="supplier-request-header">SUPPLIER REQUEST FORM</div>
